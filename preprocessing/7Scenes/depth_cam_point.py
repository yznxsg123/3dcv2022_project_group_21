...
# generate camera 3d point coordinates. size: [h, w]
def depth_to_3dpoint(depth, h, w, depth_scale, I=None):
    if (I is None):
...
def main(root_dir, val, h=256, w=341, depth_scale=1000):
    ...
    for i, fulld_img in enumerate(fulld_imgs):
        ...
        # d[d>3600] = 0
        coords = depth_to_3dpoint(fulld_resized, h, w, depth_scale)
        output_path = fulld_img.replace('full_depth.png', 'cam_points.npy')
